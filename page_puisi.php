<div class="post-popular ">
    ...
    <div class="content row ">
      <?php
        $data = $conn->query("SELECT * FROM tb_post WHERE kategori='Puisi' AND status='publis'");
        while($d = mysqli_fetch_array($data)){
      ?>
      <div class="col-md-2 mx-md-3 datatab">
        <div class="cover">
            <img src="images/athala.jpg<?php echo $d['photo'] ?>" alt="<?php echo $d['judul'];?>" height="300" class="img-hover">
            <div class="middle">
