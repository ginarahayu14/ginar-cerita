...
<?php else : ?>
    ...
    <div class="container pt-md-3">
        ...
        <div class="row mt-md-2">
            ...
            ?>
                <div class="col-md-6 ">
                    <a href="beranda.php?beranda=kategori&id=<?php echo $d['id'] ?>" style="color: black; text-decoration: none;">
                        <div class="shadow  p-3 pt-5 pb-5 mb-5  rounded" style="background-color: #6096B4;"><?php echo $d['nama'] ?></div>
                    </a>
                </div>
            <?php
